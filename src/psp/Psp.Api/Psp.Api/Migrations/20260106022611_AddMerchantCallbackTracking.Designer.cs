...
namespace Psp.Api.Migrations
{
    ...
    [Migration("20260106022611_AddMerchantCallbackTracking")]
    partial class AddMerchantCallbackTracking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Psp.Api.Data.Entities.PspTransaction", b =>
                {
                    ...
                    b.Property<DateTime?>("MerchantNotifiedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("MerchantNotifyAttempts")
                        .HasColumnType("integer");

                    b.Property<string>("MerchantNotifyLastError")
                        .HasColumnType("text");
